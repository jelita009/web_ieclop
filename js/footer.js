class MainFooter extends HTMLElement {
    connectedCallback() {
        // Saya memastikan tidak ada class tailwind seperti bg-[] yang menimpa CSS eksternal kita
        this.innerHTML = `
            ...
            <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-2 text-sm text-gray-400">
                        <a href="index.html" class="hover:text-blue-300 transition" data-i18n="navHome">Beranda</a>
                        <a href="about.html" class="hover:text-blue-300 transition" data-i18n="navAbout">Tentang Kami</a>
                        <a href="education.html" class="hover:text-blue-300 transition">Education</a>
                        
                        <a href="infocom.html" class="hover:text-blue-300 transition" data-i18n="footerInfocom">Infokom</a>
