...
<!--                            <a href="#" onclick="showDivision('EDU')"><i class="fa-solid fa-users-gears mr-2"></i> Education</a>-->
<!--                            <a href="#" onclick="showDivision('INF')"><i class="fa-solid fa-book-open-reader mr-2"></i> Infocom</a>-->
<!--                            <a href="#" onclick="showDivision('REG')"><i class="fa-solid fa-bullhorn mr-2"></i> Regeneration</a>-->
<!--                            <a href="#" onclick="showDivision('PR')"><i class="fa-solid fa-bullhorn mr-2"></i> Public Relation</a>-->
<!--                            <a href="#" onclick="showDivision('OLY')"><i class="fa-solid fa-bullhorn mr-2"></i> Olympic</a>-->
<!--                        </div>-->
                        <div class="dropdown-content">
                            <a href="#" onclick="showDivision('EDU')">
                                <i class="fa-solid fa-graduation-cap mr-2"></i> Education
                            </a>
                            
                            <a href="#" onclick="showDivision('INF')">
                                <i class="fa-solid fa-laptop-code mr-2"></i> Infocom
                            </a>
                            
                            <a href="#" onclick="showDivision('REG')">
                                <i class="fa-solid fa-user-plus mr-2"></i> Regeneration
                            </a>
                            
                            <a href="#" onclick="showDivision('PR')">
                                <i class="fa-solid fa-handshake-angle mr-2"></i> Public Relation
                            </a>
                            
                            <a href="#" onclick="showDivision('OLY')">
