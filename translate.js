const translations = {
    id: {
        ...
        news3Title: "Selamat & Sukses: Penerima Pendanaan PKM-RE 2026 🏆",
        news3Desc: "Selamat kepada Muzzakir Rifaa, Friyal Nabila, dan Reza Mauliza atas keberhasilannya meraih pendanaan dalam ajang bergengsi nasional Program Kreativitas Mahasiswa (PKM) 2026 untuk skema Riset Eksakta (PKM-RE). 🩵<br>Pencapaian ini membuktikan bahwa sinergi dan kerja keras dalam penelitian mampu melahirkan inovasi yang solutif. Selamat menjalankan risetnya, semoga hasil penelitian kalian memberikan dampak nyata bagi perkembangan ilmu pengetahuan!",
        NewsDate3: "30 Mei 2026",
        ...
        News5Title: "Dokumentasi Rekap – HOCO XI 📸",
        News5Desc: "Setiap momen menandai awal yang baru. Dari perkumpulan pertama hingga setiap pengalaman yang dibagikan, HOCO XI menjadi tempat untuk belajar, terhubung, dan tumbuh bersama 🌟🤝 Terima kasih kepada semua orang yang telah membuat perjalanan ini begitu berkesan. Ini baru permulaan, dan kami tidak sabar menunggu apa yang akan datang selanjutnya! ✨💙 🧭 Navigate the Future, Lead the Journey.",
        NewsDate5: "28 Juni 2026",
        ...
        NewsDate13: "05 Juli 2026",
        News13Title: "IECLOP GATHERING 2026 ‼️ 🌊",
        News13Desc: "Hi IECLOPers! 💙👋 Sesuatu yang seru sedang dalam perjalanan 👀 Penantian hampir berakhir. Bersiaplah untuk momen tak terlupakan, ikatan yang lebih kuat, dan kenangan tanpa akhir ✨ IECLOP GATHERING 2026 ‼️ 🌊 \"Waves of Legacy: From One Generation to Another\" Di mana cerita kita mengalir maju, bergandengan tangan 💙 📋 DETAIL PENDAFTARAN: 🗓️ Buka: 2 Juli – 8 Juli ⏰ Waktu: 10.00 - 16.00 WIB 📍 Tempat: Sekretariat UKM IECLOP, Lobi Lantai 1 🔗 Pendaftaran Online: https://forms.gle/szstgTZ3eMW7XDfYA 💰 Biaya: 25K 📋 DETAIL ACARA: 📅 Hari/Tanggal: Sabtu, 11 Juli 2026 🕐 Waktu: 07.30 WIB sampai selesai 📍 Lokasi Acara: Black Rose 👗 Dress Code: Biru dan Krem 📝 Catatan: • Bawa Tumbler + Air Minum • Perlengkapan Alat Salat • Hadiah dibungkus koran.",
        NewsDate14: "13 Juli 2026",
        News14Title: "Selamat 🩵✨",
        News14Desc: "Kami dengan bangga mengucapkan selamat kepada Sarajulis (Tata Niaga '25) atas pencapaiannya sebagai Juara 2 (1st Runner Up) dalam Kompetisi Duta Muda CBP Rupiah 2026 yang diselenggarakan oleh Kantor Perwakilan Bank Indonesia (KPwBI) Lhokseumawe 🎉 Pencapaian luar biasa ini mencerminkan dedikasi, rasa percaya diri, dan komitmenmu untuk memberikan dampak positif sebagai duta muda. Semoga keberhasilan ini menginspirasi kamu untuk terus tumbuh, memberikan kontribusi yang bermakna, dan mencapai prestasi yang lebih besar di masa depan. Tetaplah bersinar dan terus buat kami bangga! 🚀",
        ...
        statDiv: "DIVISI", statOff: "PENGURUS", statMem: "ANGGOTA",
        aboutDivisionsTitle: "DIVISI <span class='highlight text-blue-300'>SPESIALIS KAMI</span>",
        divEduTitle: "EDUCATION <span>📖</span>",
        divEduDesc: "<b>Divisi Education</b> merupakan divisi yang berfokus pada pengembangan keterampilan Akademik. Program unggulan yg dijalankan antara lain Weekly Study, yaitu sesi belajar rutin yg membahas topik topik pengetahuan umum maupun spesifik tentang bahasa Inggris. TOEFL Class, untuk meningkatkan kemampuan dalam menghadapi tes TOEFL melalui pembahasan materi, strategi dan latihan soal. Special Class, untuk memperluas wawasan Bahasa lainnya. Dengan program-program ini, dapat menciptakan lingkungan belajar yang interaktif dan produktif.",
        divInfTitle: "INFOCOM <span>🎦</span>",
        divInfDesc: "<b>Divisi Infocom</b> (Information & Communication) adalah bidang yang bertanggung jawab dibidang informasi dan komunikasi serta sebagai media untuk menyebarkan informasi dalam bentuk info, konten, serta publikasi dan komunikasi baik secara online maupun offline. Bidang Infocom juga memiliki beberapa bagian didalamnya, seperti Manajemen Media Sosial, Redaksi, Discord, dan Mading.",
        divRegTitle: "REGENERATION <span>🫂</span>",
        divRegDesc: "<b>Divisi Regeneration</b> atau biasa disebut Kaderisasi adalah divisi yang bertugas untuk mencari kader baru dan membangun kebersamaan di UKM IECLOP. Melalui program kerja seperti Open Recruitment, Home Coming, Keep in Touch, Internship, PDH Day, IBound, dan IE-Greet, Divisi Regeneration berusaha membangun kedekatan antar anggota serta menumbuhkan semangat kebersamaan dan kepemimpinan di dalam UKM IECLOP. Divisi ini juga berperan untuk membina dan mempersiapkan member untuk melanjutkan estafet kepengurusan di UKM IECLOP.",
        divPrTitle: "PUBLIC RELATION <span>👁️‍🗨️</span>",
        ...
        adminDesc: "Silakan masuk untuk mengelola tugas divisi.",
        adminBtn: "MASUK SEKARANG",
        adminBack: "KEMBALI KE BERANDA",

        // Admin Dashboard Page
        adminDashTitle: "ADMIN <span class='text-blue-300'>DASHBOARD</span>",
    ...
    en: {
        ...
        NewsDate1: "Mei 29, 2026",
        news2Title: "Congratulations: 2026 P2MW Funding Recipients 🏆",
        news2Desc: "Congratulations to Muhammad Fikri Abdillah (Electrical Engineering '22) and Cut Naila Aqqilah (Chemical Engineering '25) on receiving funding from the 2026 Student Entrepreneurship Development Program (P2MW) under the Growing Business Stage Category. 🩵<br>This achievement proves that dedication and solid innovation can foster a highly competitive business. Best of luck on expanding your venture, and may it bring impactful success ahead!",
        NewsDate2: "Mei 29, 2026",
        news3Title: "Congratulations: 2026 PKM-RE Funding Recipients 🏆",
        news3Desc: "Congratulations to Muzzakir Rifaa, Friyal Nabila, and Reza Mauliza on receiving funding from the 2026 Student Creativity Program (PKM) under the PKM-RE (Exact Sciences Research) Scheme. 🩵<br>This achievement proves that synergy and dedication in scientific exploration can lead to impactful innovations. Best of luck with your research, and may it yield outstanding findings for the scientific community!",
        NewsDate3: "Mei 30, 2026",
        ...
        News5Title: "Recap Documentation – HOCO XI 📸",
        News5Desc: "Every moment marked a new beginning. From our first gathering to every shared experience, HOCO XI became a place to learn, connect, and grow together 🌟🤝 Thank you to everyone who made this journey so memorable. This is just the beginning, and we can't wait for what's next! ✨💙 🧭 Navigate the Future, Lead the Journey.",
        NewsDate5: "June 28, 2026",
        ...
        NewsDate11: "June 15, 2026",
        News11Title: "Recap Documentation – Monthly Study 📚💙",
        News11Desc: "IECLOP successfully held the first session of Monthly Study with the topic “Simple Present Tense”. Through this session, participants had the opportunity to learn, practice, and improve their understanding of one of the most essential English tenses in a fun and interactive environment. ✨ Thank you to everyone who joined us. See you at the next Monthly Study!",
        NewsDate12: "July 04, 2026",
        ...
        NewsDate13: "July 05, 2026",
        News13Title: "IECLOP GATHERING 2026 ‼️ 🌊",
        NewsDate14: "July 13, 2026",
        News14Title: "Congratulations 🩵✨",
        News14Desc: "We proudly congratulate Sarajulis (Business '25) on achieving 1st Runner Up in the Duta Muda CBP Rupiah 2026 Competition organized by Bank Indonesia Representative Office (KPwBI) Lhokseumawe 🎉 This remarkable achievement reflects your dedication, confidence, and commitment to making a positive impact as a young ambassador. May this success inspire you to continue growing, creating meaningful contributions, and reaching even greater milestones in the future. Keep shining and keep making us proud! 🚀",
        ...
        statDiv: "DIVISIONS", statOff: "OFFICERS", statMem: "MEMBERS",
        aboutDivisionsTitle: "OUR SPECIALIST <span class='highlight text-blue-300'>DIVISIONS</span>",
        divEduTitle: "EDUCATION <span>📖</span>",
        divEduDesc: "<b>Education Division</b> focuses on developing academic skills. Its flagship programs include Weekly Study, a routine learning session discussing general and specific topics in English. TOEFL Class aims to improve skills for the TOEFL test through material discussion, strategies, and practice. Special Class expands knowledge of other languages. These programs create an interactive and productive learning environment.",
        divInfTitle: "INFOCOM <span>🎦</span>",
        divInfDesc: "<b>Infocom Division</b> (Information & Communication) is responsible for information and communication, serving as a medium to disseminate information in the form of news, content, publication, and communication both online and offline. Infocom also has several sub-divisions, such as Social Media Management, Editorial, Discord, and Wall Magazine.",
        divRegTitle: "REGENERATION <span>🫂</span>",
        divRegDesc: "<b>Regeneration Division</b>, also known as Cadreization, is tasked with finding new cadres and building togetherness in UKM IECLOP. Through work programs such as Open Recruitment, Home Coming, Keep in Touch, Internship, PDH Day, IBound, and IE-Greet, the Regeneration Division seeks to build closeness among members and foster a spirit of togetherness and leadership. This division also plays a role in fostering and preparing members to continue the management relay.",
        divPrTitle: "PUBLIC RELATION <span>👁️‍🗨️</span>",
        ...
        // Login Admin Page
        adminTitle: "ADMIN PANEL",
        adminDesc: "Please log in to manage division tasks.",
        adminBtn: "LOGIN NOW",
...
function changeLanguage(lang) {
   ...
   document.querySelectorAll('[data-i18n]').forEach(element => {
    ...
    if (btnId) btnId.classList.toggle('lang-active', lang === 'id');
    if (btnEn) btnEn.classList.toggle('lang-active', lang === 'en');

    // 4. Trigger khusus untuk script JavaScript Dinamis (Divisi & Admin)
    if (typeof window.updateLocalContent === 'function') {
        window.updateLocalContent(lang);
    }
}
